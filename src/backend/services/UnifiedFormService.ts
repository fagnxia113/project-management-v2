...
// 表单字段类型
export type FormFieldType = 'text' | 'number' | 'date' | 'select' | 'textarea' | 'boolean' | 'user' | 'lookup' | 'array' | 'images' | 'files';
          ...
          },
          {
            ...
            arrayConfig: {
              fields: [
                ...
                {
                  id: 'field-manage-code',
                  name: 'manage_code',
                  label: '管理编码',
                  type: 'text',
                  required: false,
                  placeholder: '请输入管理编码（系统将校验唯一性，不填则自动生成）',
