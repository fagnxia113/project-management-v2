...
VALUES (
  ...
  JSON_OBJECT(
    ...
    'edges', JSON_ARRAY(
      ...
      JSON_OBJECT('id', 'edge-4', 'source', 'gm', 'target', 'end-approved')
    )
  ),
  JSON_ARRAY(
    -- ========== 基本信息 ==========
    ...
    JSON_OBJECT('name', 'technical_lead_id', 'label', '技术负责人', 'type', 'user', 'required', false, 'placeholder', '请选择技术负责人', 'group', '基本信息'),
    ...
    JSON_OBJECT('name', 'type', 'label', '项目类型', 'type', 'select', 'required', false, 'defaultValue', 'domestic', 'options', JSON_ARRAY(
    ...
    JSON_OBJECT('name', 'end_customer', 'label', '最终客户', 'type', 'text', 'required', false, 'placeholder', '请输入最终客户名称', 'group', '商务信息'),
